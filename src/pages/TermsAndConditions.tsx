      ...
      <div className="container mx-auto">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-md border border-saudi-light arabesque-bg">
          ...
          <div className="space-y-6 text-lg">
            ...
            <p>
              جميع المحتويات المتاحة على المنصة (بما في ذلك النصوص، الصور، الفيديوهات، والبودكاست) هي ملك لمنصة ضَـمَّـة أو مرخصة لها. لا يجوز نسخ أو توزيع أو تعديل أي من هذه المحتويات دون إذن مسبق، مع مراعاة حقوق الملكية الفكرية وفقاً للقانون الجزائري.
            </p>
