      ...
      <div className="container mx-auto">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-md border border-saudi-light arabesque-bg">
          ...
          <div className="space-y-6 text-lg">
            <p>
              نحن في منصة ضمة نلتزم بحماية خصوصية مستخدمينا. توضح سياسة الخصوصية هذه كيفية جمع واستخدام وحماية المعلومات الشخصية التي تقدمها لنا.
            </p>
            ...
            <p>
              نتخذ إجراءات أمنية مناسبة لحماية معلوماتكم الشخصية من الوصول غير المصرح به أو التغيير أو الكشف. نستخدم تقنيات تشفير متقدمة ونتبع أفضل الممارسات الأمنية.
            </p>
            ...
            <p>
              قد نقوم بتحديث سياسة الخصوصية من وقت لآخر. سنقوم بإخطاركم بأي تغييرات جوهرية من خلال المنصة أو عبر البريد الإلكتروني.
            </p>
