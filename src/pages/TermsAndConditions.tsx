      ...
      <div className="container mx-auto">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-md border border-saudi-light arabesque-bg">
          ...
          <div className="space-y-6 text-lg">
            <p>
              باستخدامكم لمنصة ضمة، فإنكم توافقون على الالتزام بهذه الشروط والأحكام. إذا لم توافقوا على هذه الشروط، يرجى عدم استخدام المنصة.
            </p>
            ...
            <p>
              جميع المحتويات المتاحة على المنصة (بما في ذلك النصوص، الصور، الفيديوهات، والبودكاست) هي ملك لمنصة ضمة أو مرخصة لها. لا يجوز نسخ أو توزيع أو تعديل أي من هذه المحتويات دون إذن مسبق.
            </p>
            ...
            <p>
              نحتفظ بالحق في تعديل هذه الشروط والأحكام في أي وقت. سيتم إخطاركم بأي تغييرات جوهرية من خلال المنصة أو عبر البريد الإلكتروني.
            </p>
            ...
            <p>
              تخضع هذه الشروط والأحكام لقوانين المملكة العربية السعودية. أي نزاع ينشأ عن استخدام المنصة سيخضع للاختصاص الحصري لمحاكم المملكة.
            </p>
